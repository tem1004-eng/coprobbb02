  ...
  const handleSaveData = () => {
    const performSave = () => {
      try {
        ...
        // 파일명 형식을 [교회이름 헌금관리]_날짜.json 으로 변경
        const fileName = `[${churchName} 헌금관리]_${todayString()}.json`;
        a.href = url;
        a.download = fileName;
...
const ExcelExportModal: React.FC<{
    ...
    const handleExport = () => {
        ...
        // 엑셀 파일명 형식도 [교회이름 헌금관리]_구분_날짜.xlsx 로 변경
        const fileName = `[${churchName} 헌금관리]_${mode}_${todayString()}.xlsx`;
